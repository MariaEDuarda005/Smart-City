...
# criando a primeira tabela de sensores
class Sensor(models.Model):
    # fazendo algumas opções de seleção do usuario, esperando que o retorno seja algo desse sentido
...
class ContadorData(models.Model):
    ...
    def __str__(self):
        return f"Contador {self.sensor} - {self.timestamp}"
